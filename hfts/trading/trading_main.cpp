...
int main(int argc, char **argv) {
  ...
  std::cout << "trading/trading_main.cpp 1" << std::endl;
  ...
  std::cout << "trading/trading_main.cpp 2" << std::endl;
  ...
  std::cout << "trading/trading_main.cpp 2.1" << std::endl;
  Exchange::ClientResponseLFQueue client_responses(ME_MAX_CLIENT_UPDATES);
  std::cout << "trading/trading_main.cpp 2.2" << std::endl;
  Exchange::MEMarketUpdateLFQueue market_updates(ME_MAX_MARKET_UPDATES);
  std::cout << "trading/trading_main.cpp 2.3" << std::endl;
  ...
  for (int i = 3; i < argc; i += 5, ++next_ticker_id) {
    std::cout << "    trading/trading_main.cpp 2.4 i=" << i << ":" << std::endl;
  ...
  std::cout << "trading/trading_main.cpp 3" << std::endl;
  ...
  trade_engine = new Trading::TradeEngine(client_id, algo_type,
                                          ...
                                          &market_updates);
  trade_engine->start();
  std::cout << "trading/trading_main.cpp 4" << std::endl;
  ...
  order_gateway->start();
  std::cout << "trading/trading_main.cpp 5" << std::endl;
  ...
  std::cout << "trading/trading_main.cpp 6" << std::endl;

  usleep(10 * 1000 * 1000);

  trade_engine->initLastEventTime();
  std::cout << "trading/trading_main.cpp 7" << std::endl;
  ...
  std::cout << "trading/trading_main.cpp 8" << std::endl;
  ...
  std::cout << "trading/trading_main.cpp 9" << std::endl;

  trade_engine->stop();
  market_data_consumer->stop();
  order_gateway->stop();
  std::cout << "trading/trading_main.cpp 10" << std::endl;
