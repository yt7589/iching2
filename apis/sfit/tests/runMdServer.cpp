...
void startServer(int port){
    ...
    std::cout << "startServer 2" << std::endl;
    ...
    std::cout << "startServer 3" << std::endl;
    ...
    std::cout << "startServer 4" << std::endl;


    while(1)
    {
        std::cout << "startServer 5" << std::endl;
        memset(buffer,0,sizeof(buffer));
        int len = recv(conn, buffer, sizeof(buffer),0);
        std::cout << "startServer 6" << std::endl;
//        if(buffer[len-1] == '\n'){
//            buffer[len] = '\0';
//            cout<<"buffer[len-1] == '\\n'"<<endl;
//        } else{
